(function($) {
    ...
    //控制栏 章节展示
    $('.player-chapter').click(function(){
        $('.player-list-bk').toggleClass('player-list-bk-show');
    });
    
    $('.player-list-bk').mouseleave(function(e){
        $('.player-list-bk').removeClass('player-list-bk-show');
        e.stopPropagation();
    });
    $('.player-list-bk').click(function(){
        $(this).removeClass('player-list-bk-show');
    });
    //声音按钮
    ...
    let psVideo_btn_all = document.getElementById('psVideo-btn-all');
    let fullarea = document.getElementById('fulldiv');
    
    psVideo_btn_all.addEventListener('click',function(){  
        if (fullscreen) {    // 退出全屏
    ...
    window.onresize = function() {
        ...
        if (isFull==false) {
            $(".myVideo-title").removeClass("myVideo-title-full");
            $(".psVideo-shade").removeClass("psVideo-shade-full");
            
        }else{
            $(".myVideo-title").addClass("myVideo-title-full");
            $(".psVideo-shade").addClass("psVideo-shade-full");
            $('#fulldiv').mousemove(function(e) {
                var positionY=e.pageY-$(this).offset().top; //获取当前鼠标相对img的Y坐标
                if(positionY<=200){
                    $(".myVideo-title-full").fadeIn();
                    $(".psVideo-shade-full").fadeIn();
                   
                }else if(positionY>=$(this).height()-200){
                    $(".myVideo-title-full").fadeIn();
                    $(".psVideo-shade-full").fadeIn();
                  
                }else{
                    $(".myVideo-title-full").fadeOut();
                    $(".psVideo-shade-full").fadeOut();
                }
            })
