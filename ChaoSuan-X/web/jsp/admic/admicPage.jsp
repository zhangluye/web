...
<section class="zhongjian">
    <div id="zj">
        <div id="zj_z">
            ...
            <div id="zj_z_bottom">
                <ul id="zj_ul" >
                    <li><a href="${pageContext.request.contextPath}/admic" id="xuanzhong">学术动态</a></li>
                </ul>
            </div>
        </div>
    </div>
    <div id="neirong">
        <div id="nr_daohang">
            <p><a href="${pageContext.request.contextPath}/Static/html/index.html">首页</a> >> <a href="${pageContext.request.contextPath}/alerts">新闻动态</a> >> <a href="${pageContext.request.contextPath}/admic">学术动态</a> >> <a href="#"><%=request.getSession().getAttribute("title")%></a></p>
        </div>
        <div id="zhengwen">
            <div id="zw_biaoti">
