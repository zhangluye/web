...
<%@ page import="com.syxy.pojo.Alerts" %>
<%@ page import="com.syxy.pojo.Admic" %>
...
<form action="${pageContext.request.contextPath}/admic">
...
<section class="zhongjian">
    <div id="zj">
        <div id="zj_z">
            <div id="zj_z_top">新闻动态</div>
            <div id="zj_z_bottom">
                <ul id="zj_ul" >
                    <li><a href="${pageContext.request.contextPath}/alerts">超算快讯</a></li>
                    <li><a href="#" id="xuanzhong">学术动态</a></li>
                    <li><a href="${pageContext.request.contextPath}/media">媒体报道</a></li>
                </ul>
            </div>
        </div>

        <% ArrayList<Admic> admicsList = (ArrayList<Admic>) request.getSession().getAttribute("admicsList"); %>

        <div id="tj">
            <div id="tj_top">推荐栏</div>
            <div id="tj_bottom">
                <ul id="tj_ul" >
                    <c:forEach var="admic" items="${admicsList}" begin="0" end="8">
                        <li style="margin: 10px auto"><a href="${pageContext.request.contextPath}/admic.one?id=${admic.id}">
                            <span style="color: white"><c:out value="${admic.title}"/>&emsp;&emsp;</span>
                        </a></li>
                    </c:forEach>
                </ul>
            </div>
    ...
    <div id="neirong">
        <div id="nr_daohang">
            <p><a href="${pageContext.request.contextPath}/Static/html/index.html">首页</a> >> <a href="${pageContext.request.contextPath}/alerts">新闻动态</a> >> <a href="#">学术动态</a>
        </div>
        <div id="zw_biaoti"><h1 style="font-size: 28px;">学术动态</h1></div>
        <div id="liebiao">


            <c:forEach var="admic" items="${admicsList}">
                <p><a href="${pageContext.request.contextPath}/admic.one?id=${admic.id}">
                    <span><c:out value="${admic.title}"/>&emsp;&emsp;</span>
                    <span><c:out value="${admic.pubTime}"/>&emsp;</span><br>
                </a></p>
