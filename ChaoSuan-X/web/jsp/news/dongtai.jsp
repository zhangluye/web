...
<section class="zhongjian">
    ...
    <div id="neirong">
        <div id="nr_daohang">
            <p><a href="${pageContext.request.contextPath}/Static/html/index.html">首页</a> >> <a href="#">公告公示</a>
        </div>
        <div id="liebiao">
<%--            <p><a href="../Static/html/gonggao/html/dongtai1.html">论数字经济，谋海南发展——我院院长刘开南教授做客南海网三亚演播室视频访谈</a></p>--%>


    <c:forEach var="news" items="${newsList}">
        <%--<p><a href="${pageContext.request.contextPath}/jsp/news/newsPage.jsp?id=${news.id}&title=${news.title}&context=${news.context}&pubTime=${news.pubTime}">--%>
        <p><a href="${pageContext.request.contextPath}/news.one?id=${news.id}">
