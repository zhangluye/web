...
<%@ page import="com.syxy.pojo.Media" %>
...
<section class="zhongjian">
        ...
        <div id="zj_z">
            ...
            <div id="zj_z_bottom">
                <ul id="zj_ul" >
                    ...
                    <li><a href="#" id="xuanzhong">媒体报道</a></li>
                </ul>
            </div>
        </div>

        <% ArrayList<Media> mediaList = (ArrayList<Media>) request.getSession().getAttribute("mediaList"); %>

        <div id="tj">
            <div id="tj_top">推荐栏</div>
            <div id="tj_bottom">
                <ul id="tj_ul" >
                    <c:forEach var="media" items="${mediaList}" begin="0" end="8">
                        <li style="margin: 10px auto"><a href="${pageContext.request.contextPath}/media.one?id=${media.id}">
                            <span style="color: white"><c:out value="${media.title}"/>&emsp;&emsp;</span>
                        </a></li>
                    </c:forEach>
                </ul>
            </div>
    ...
    <div id="neirong">
        <div id="nr_daohang">
            <p><a href="${pageContext.request.contextPath}/Static/html/index.html">首页</a> >> <a href="${pageContext.request.contextPath}/alerts">新闻动态</a> >> <a href="#">媒体报道</a>
        </div>
        <div id="zw_biaoti"><h1 style="font-size: 28px;">媒体报道</h1></div>
        <div id="liebiao">


            <c:forEach var="media" items="${mediaList}">
                <p><a href="${pageContext.request.contextPath}/media.one?id=${media.id}">
                    <span><c:out value="${media.title}"/>&emsp;&emsp;</span>
                    <span><c:out value="${media.pubTime}"/>&emsp;</span><br>
                </a></p>
