...
<nav>
    <div class="navTo widthBox">
        <div class="logo">
            <a href="${pageContext.request.contextPath}/Static/html/index.html"><img src="../../Static/images/logo.png" alt="LOGO"></a>
...
<section class="zhongjian">
    <div id="zj">
        <div id="zj_z">
            ...
            <div id="zj_z_bottom">
                <ul id="zj_ul" >
                    <li><a href="${pageContext.request.contextPath}/alerts" id="xuanzhong">超算快讯</a></li>
                </ul>
            </div>
        </div>
    </div>
    <div id="neirong">
        <div id="nr_daohang">
            <p><a href="../../Static/html/index.html">首页</a> >> <a href="${pageContext.request.contextPath}/alerts">新闻动态</a> >> <a href="${pageContext.request.contextPath}/alerts">超算快讯</a> >> <a href="#"><%=request.getSession().getAttribute("title")%></a></p>
        </div>
        <div id="zhengwen">
            <div id="zw_biaoti">
                <h1 style="font-size: 28px;"><%=request.getSession().getAttribute("title")%></h1>
                <div id="shuju">
                    <p style="float: left;margin-left: 8px;">浏览次数:<span id="cishu">1</span></p>
                    <p style="float: right;">发表日期:<span id="riqi"><%=request.getSession().getAttribute("pubTime")%></span></p>
                </div>
            </div>
            <div id="wenzi">
                <p class="suojin">
