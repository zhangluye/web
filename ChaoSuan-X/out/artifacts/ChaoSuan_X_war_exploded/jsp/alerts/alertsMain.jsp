...
<section class="zhongjian">
    <div id="zj">
        <div id="zj_z">
            ...
            <div id="zj_z_bottom">
                <ul id="zj_ul" >
                    <li><a href="#" id="xuanzhong">超算快讯</a></li>
                    <li><a href="${pageContext.request.contextPath}/admic">学术动态</a></li>
                    <li><a href="${pageContext.request.contextPath}/media">媒体报道</a></li>
                </ul>
            </div>
        </div>

    <% ArrayList<Alerts> alertsList = (ArrayList<Alerts>) request.getSession().getAttribute("alertsList"); %>

    <div id="tj">
        <div id="tj_top">推荐栏</div>
        <div id="tj_bottom">
            <ul id="tj_ul" >
                <c:forEach var="alerts" items="${alertsList}" begin="0" end="8">
                    <li style="margin: 10px auto"><a href="${pageContext.request.contextPath}/alerts.one?id=${alerts.id}">
                        <span style="color: white"><c:out value="${alerts.title}"/>&emsp;&emsp;</span>
                    </a></li>
                </c:forEach>
            </ul>
        </div>
    ...
    <div id="neirong">
        <div id="nr_daohang">
            <p><a href="${pageContext.request.contextPath}/Static/html/index.html">首页</a> >> <a href="${pageContext.request.contextPath}/alerts">新闻动态</a> >> <a href="#">超算快讯</a>
        </div>
        <div id="zw_biaoti"><h1 style="font-size: 28px;">超算快讯</h1></div>
        <div id="liebiao">

            <c:forEach var="alerts" items="${alertsList}">
                <p><a href="${pageContext.request.contextPath}/alerts.one?id=${alerts.id}">
                    <span><c:out value="${alerts.title}"/>&emsp;&emsp;</span>
                    <span><c:out value="${alerts.pubTime}"/>&emsp;</span><br>
                </a></p>
...
<footer>
    <div class="fromT">
        <div class="widthBox clearfix1">
            ...
            <img src="../../Static/images/weixing.jpg">
        </div>
    </div>
    <div class="fromB">
